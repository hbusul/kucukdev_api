...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.UpdateLessonModel();
  });
  ...
  describe('UpdateLessonModel', function() {
    it('should create an instance of UpdateLessonModel', function() {
      ...
      //var instane = new FastApi.UpdateLessonModel();
      //expect(instance).to.be.a(FastApi.UpdateLessonModel);
    });

    it('should have the property name (base name: "name")', function() {
      // uncomment below and update the code to test the property name
      //var instance = new FastApi.UpdateLessonModel();
