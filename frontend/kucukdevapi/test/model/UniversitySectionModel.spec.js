...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kucukdevapi.UniversitySectionModel();
  });
  ...
  describe('UniversitySectionModel', function() {
    it('should create an instance of UniversitySectionModel', function() {
      ...
      //var instance = new Kucukdevapi.UniversitySectionModel();
      //expect(instance).to.be.a(Kucukdevapi.UniversitySectionModel);
    });
