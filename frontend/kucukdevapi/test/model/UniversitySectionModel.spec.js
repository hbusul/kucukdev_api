...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.UniversitySectionModel();
  });
  ...
  describe('UniversitySectionModel', function() {
    it('should create an instance of UniversitySectionModel', function() {
      // uncomment below and update the code to test UniversitySectionModel
      //var instane = new FastApi.UniversitySectionModel();
      //expect(instance).to.be.a(FastApi.UniversitySectionModel);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new FastApi.UniversitySectionModel();
