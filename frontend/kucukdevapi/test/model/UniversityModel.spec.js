...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.UniversityModel();
  });
  ...
  describe('UniversityModel', function() {
    it('should create an instance of UniversityModel', function() {
      ...
      //var instane = new FastApi.UniversityModel();
      //expect(instance).to.be.a(FastApi.UniversityModel);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new FastApi.UniversityModel();
