...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kucukdevapi.UniversityLessonAPIModel();
  });
  ...
  describe('UniversityLessonAPIModel', function() {
    it('should create an instance of UniversityLessonAPIModel', function() {
      // uncomment below and update the code to test UniversityLessonAPIModel
      //var instance = new Kucukdevapi.UniversityLessonAPIModel();
      //expect(instance).to.be.a(Kucukdevapi.UniversityLessonAPIModel);
    });
