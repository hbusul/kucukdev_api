...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.CurriculumSemesterModel();
  });
  ...
  describe('CurriculumSemesterModel', function() {
    it('should create an instance of CurriculumSemesterModel', function() {
      ...
      //var instane = new FastApi.CurriculumSemesterModel();
      //expect(instance).to.be.a(FastApi.CurriculumSemesterModel);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new FastApi.CurriculumSemesterModel();
