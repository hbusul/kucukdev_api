...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kucukdevapi.UniversityLessonModel();
  });
  ...
  describe('UniversityLessonModel', function() {
    it('should create an instance of UniversityLessonModel', function() {
      ...
      //var instance = new Kucukdevapi.UniversityLessonModel();
      //expect(instance).to.be.a(Kucukdevapi.UniversityLessonModel);
    });
