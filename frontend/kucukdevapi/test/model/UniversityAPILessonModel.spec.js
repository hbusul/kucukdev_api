...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Kucukdevapi.UniversityAPILessonModel();
  });
  ...
  describe('UniversityAPILessonModel', function() {
    it('should create an instance of UniversityAPILessonModel', function() {
      ...
      //var instance = new Kucukdevapi.UniversityAPILessonModel();
      //expect(instance).to.be.a(Kucukdevapi.UniversityAPILessonModel);
    });
