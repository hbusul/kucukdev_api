...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.UserAPIModel();
  });
  ...
  describe('UserAPIModel', function() {
    it('should create an instance of UserAPIModel', function() {
      ...
      //var instane = new FastApi.UserAPIModel();
      //expect(instance).to.be.a(FastApi.UserAPIModel);
    });

    it('should have the property id (base name: "_id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new FastApi.UserAPIModel();
