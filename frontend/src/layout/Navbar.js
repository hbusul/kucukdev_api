                ...
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between py-4">
                        ...
                        <div className="hidden sm:flex sm:items-center">
                            <Link to="/products" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Products</Link>
                            <Link to="/semesters" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Marketplace</Link>
                            <Link to="/semesters" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Partners</Link>
                            <Link to="/semesters" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Pricing</Link>
                        </div>
                        ...
                        <div className="flex flex-col">
                            {
                                isVisible ? <div className="flex flex-row justify-between">
                                    <Link to="/products" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Products</Link>
                                    <Link to="/semesters" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Marketplace</Link>
                                    <Link to="/semesters" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Partners</Link>
                                    <Link to="/semesters" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Pricing</Link>
                                </div> : null
                            }
