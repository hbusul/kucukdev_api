                                ...
                                <div className="flex items-center justify-between py-4">
                                    ...
                                    {!isLogin ?
                                        ...
                                        <div className="hidden sm:flex sm:items-center">
                                            ...
                                            <Link to="/" onClick={onLogoutUser.bind(this, dispatch)} className="text-gray-800 text-lg font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Logout</Link>
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        {!isLogin ?
                                            ...
                                            <div>
                                                ...
                                                <Link to="/" onClick={onLogoutUser.bind(this, dispatch)} className="text-gray-800 text-md font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Logout</Link>
