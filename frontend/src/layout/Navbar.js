        ...
        <nav className="bg-white md:h-24 shadow">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between py-4">
                    <Link to="">
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-blue-600" viewBox="0 0 24 24">
                    ...
                    {login &&
                        <div className="hidden sm:flex sm:items-center">
                            <Link to="/overview" className="text-gray-800 text-md font-semibold hover:text-blue-600 mr-3 lg:mr-6">Overview</Link>
                            <Link to="/semesters" className="text-gray-800 text-md font-semibold hover:text-blue-600 mr-3 lg:mr-6">Semesters</Link>

                            <div className="dropdown inline-block relative">
                                <button className="text-gray-800 text-md font-semibold hover:text-blue-600 mr-3 lg:mr-6 inline-flex items-center"><span className="mr-1">Lessons</span>
                                    <svg className="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z" /> </svg></button>

                                <ul className="dropdown-menu absolute hidden text-gray-700 pt-1 whitespace-nowrap">
                                    <Link to="/lessons" className="bg-gray-100 hover:bg-gray-200 py-2 px-8 block text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">Show Lessons</Link>
                                    <Link to="/lessons/add-lesson" className="bg-gray-100 hover:bg-gray-200 py-2 px-8 block text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">Add Lesson</Link>
                                    <Link to="/lessons/add-from-uis" className="bg-gray-100 hover:bg-gray-200 py-2 px-8 block text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">Add from UIS</Link>
                                </ul>
                            </div>
                    ...
                    {!login ?
                        <div className="hidden sm:flex sm:items-center">
                            <Link to="/signin" className="text-gray-800 text-md font-semibold hover:text-blue-600 mr-4">Sign in</Link>
                            <Link to="/signup" className="text-gray-800 text-md font-semibold border px-4 py-2 rounded-md hover:text-blue-600 hover:border-blue-600">Sign up</Link>
                        </div>
                        :
                        <div className="hidden sm:flex sm:items-center">
                    ...
                    <div className="flex flex-col">
                        ...
                        {!login ?
                            <div className="flex justify-between items-center border-t-2 pt-2 mx-4">
                                <Link to="/signin" className="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">Sign in</Link>
                                <Link to="/signup" className="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-blue-600 hover:border-blue-600">Sign up</Link>
                            </div>
                            :
                            <div>
                                <Link to="/" className="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">Profile</Link>
                                <Link to="/" onClick={onLogoutUser.bind()} className="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-blue-600 hover:border-blue-600">Logout</Link>
