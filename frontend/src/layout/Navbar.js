                ...
                <div className="flex items-center justify-between py-4">
                    ...
                    {login &&
                        <div className="hidden sm:flex sm:items-center">
                            <Link to="/overview" className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-3 lg:mr-6">Overview</Link>
                            <Link to="/semesters" className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-3 lg:mr-6">Semesters</Link>

                            <div className="dropdown inline-block relative">
                                <button className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-3 lg:mr-6 inline-flex items-center"><span className="mr-1">Lessons</span>
                                ...
                                <ul className="dropdown-menu absolute hidden text-gray-700 pt-1 whitespace-nowrap">
                                    <Link to="/lessons" className="bg-gray-100 hover:bg-gray-200 py-2 px-8 block text-gray-800 text-sm font-semibold hover:text-purple-600 mb-1">Show Lessons</Link>
                            ...
                            <Link to="/attendance" className="text-gray-800 text-md font-semibold hover:text-purple-600">Attendance</Link>
                        </div>
                    ...
                    {!login ?
                        ...
                        <div className="hidden sm:flex sm:items-center">
                            ...
                            <Link to="/" onClick={onLogoutUser.bind()} className="text-gray-800 text-md font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Logout</Link>
                    ...
                    <div className="flex flex-col">
                        ...
                        {!login ?
                            ...
                            <div>
                                ...
                                <Link to="/" onClick={onLogoutUser.bind()} className="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Logout</Link>
