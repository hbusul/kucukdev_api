                                ...
                                <div className="container mx-auto px-4">
                                    <div className="flex items-center justify-between py-4">
                                        ...
                                        <div className="hidden sm:flex sm:items-center">
                                            <Link to="/overview" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Overview</Link>
                                            <Link to="/semesters" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Semesters</Link>
                                            <Link to="/lessons" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Lessons</Link>
                                            <Link to="/attendance" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Attendance</Link>
                                        </div>
                                        {!isLogin ?
                                            <div className="hidden sm:flex sm:items-center">
                                                <Link to="/signin" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Sign in</Link>
                                                <Link to="/signup" className="text-gray-800 text-lg font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</Link>
                                            </div>
                                            :
                                            <div className="hidden sm:flex sm:items-center">
                                                <Link to="/" className="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">{userEmail}</Link>
                                                <Link to="/" onClick={this.onLogoutUser.bind(this, dispatch)} className="text-gray-800 text-lg font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Logout</Link>

                                            </div>
                                        }


                                        <div className="sm:hidden cursor-pointer" onClick={this.onClickEvent}>
                                        ...
                                        <div className="flex flex-col">
                                            {
                                                isVisible ? <div className="flex flex-row justify-between">
                                                    <Link to="/overview" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Overview</Link>
                                                    <Link to="/semesters" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Semesters</Link>
                                                    <Link to="/lessons" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Lessons</Link>
                                                    <Link to="/attendance" className="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Attendance</Link>
                                                </div> : null
                                            }
                                            {!isLogin ?
                                                <div className="flex justify-between items-center border-t-2 pt-2 mx-4">
                                                    ...
                                                    <Link to="/signup" className="text-gray-800 text-md font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</Link>
                                                </div>
                                                :
                                                <div>
                                                    <Link to="/" className="text-gray-800 text-md font-semibold hover:text-purple-600 mr-4">{userEmail}</Link>
                                                    <Link to="/" onClick={this.onLogoutUser.bind(this, dispatch)} className="text-gray-800 text-md font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Logout</Link>
