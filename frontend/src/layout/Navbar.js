...
class Navbar extends Component {
    ...
    render() {
        ...
        return (
            <nav class="bg-white md:h-28 shadow">
                <div class="container mx-auto px-4">
                    <div class="flex items-center justify-between py-4">
                        <Link to="">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-16 h-16 text-purple-600" viewBox="0 0 24 24">
                        ...
                        <div class="hidden sm:flex sm:items-center">
                            <Link to="/products" class="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Products</Link>
                            <Link to="/semesters" class="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Marketplace</Link>
                            <Link to="/semesters" class="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Partners</Link>
                            <Link to="/semesters" class="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Pricing</Link>
                        </div>

                        <div class="hidden sm:flex sm:items-center">
                            <Link to="/signin" class="text-gray-800 text-lg font-semibold hover:text-purple-600 mr-4">Sign in</Link>
                            <Link to="/signup" class="text-gray-800 text-lg font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</Link>
                        </div>

                        <div class="sm:hidden cursor-pointer" onClick={this.onClickEvent}>
                    ...
                    <div class="block sm:hidden bg-white border-t-2 py-2">
                        <div class="flex flex-col">
                            {
                                isVisible ? <div class="flex flex-row justify-between">
                                    <Link to="/products" class="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Products</Link>
                                    <Link to="/semesters" class="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Marketplace</Link>
                                    <Link to="/semesters" class="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Partners</Link>
                                    <Link to="/semesters" class="text-gray-800 text-md font-semibold hover:text-purple-600 mb-1">Pricing</Link>
                                </div> : null
                            }
                            <div class="flex justify-between items-center border-t-2 pt-2 mx-4">
                                <Link to="/signin" class="text-gray-800 text-md font-semibold hover:text-purple-600 mr-4">Sign in</Link>
                                <Link to="/signup" class="text-gray-800 text-md font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</Link>
                            </div>
                        </div>
                    </div>
                </div>
