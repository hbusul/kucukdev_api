      ...
      (error, data, response) => {
        if (error) {
          ...
          for (let i = 0; i < data.length; i++) {
            if (startYear >= data[i].startYear && startYear < data[i].endYear) {
              const localLessonGroups = {};
              for (let j = 0; j < data[i].semesters.length; j++) {
                if (nthSemester === data[i].semesters[j].semester) {
                  ...
                  for (
                    ...
                    if (
                      !(
                        data[i].semesters[j].lessons[k].lessonType in
                        localLessonGroups
                      )
                    )
                      localLessonGroups[
                        data[i].semesters[j].lessons[k].lessonType
                      ] = [];
                    localLessonGroups[
                      data[i].semesters[j].lessons[k].lessonType
                    ...
                    if (
                      data[i].semesters[j].lessons[k].lessonType === "default"
                    ) {
                      selectedLessons.push(data[i].semesters[j].lessons[k]);
                    } else {
                      if (
                        localLessonGroups[
                          data[i].semesters[j].lessons[k].lessonType
                ...
                <ul className="list-disc ml-4 md:ml-12">
                  <li>
                    <p className="mt-4 md:mt-8 text-justify">
                      To be able use this functionality you should select a
                      university from options below.
                    </p>
                  </li>
                  <li>
                    <p className="my-2 md:my-5 text-justify">
                      You can change your selection later in your profile
                      settings.
                    </p>
                  </li>
                  <li>
                    <p className="my-2 md:my-5 text-justify">
                      If your university is not in the list, please inform us
              ...
              {!showCurriculum ? (
                <div className="flex h-full">
                  <div className="flex bg-white shadow-xl rounded flex-col md:w-2/3 sm:w-full mx-auto mt-4">
                    <div className="w-full flex">
                      ...
                      ></div>
                      <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none mx-auto">
                        <h3 className="text-2xl">Prepare Your Schedule</h3>
                        <form
                          onSubmit={onSelectDepartmentInformation.bind(this)}
                          className="px-8 pt-6 pb-8 mb-4 bg-white rounded"
                        >
                          <div className="mb-4">
                          ...
                          <div className="mb-4">
                            <label className="block mb-2 text-md font-bold text-gray-700 text-left">
                              When did you start your 1st year?
                            </label>
                            <select
                              value={startYear}
                ...
                <div className="xl:mx-40">
                    ...
                    <div className="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard md:px-8 pt-2 pb-8 rounded-bl-lg rounded-br-lg">
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white">
                          {Object.keys(lessonGroups).map((group, index) => (
                            <>
                              {index > 0 && (
                                <tr>
                                  <td></td>
                              ...
                              <tr
                                className={priColors[index % priColors.length]}
                              >
                                ...
                                <td className="px-4 py-3 border-b text-blue-900 border-gray-500 text-sm leading-5">
                                  {`${year}${suffixes[year - 1]} Year, ${
                                    nthSemester % 2 === 1 ? "1" : "2"
                                  }${
                                    suffixes[nthSemester % 2 === 1 ? 0 : 1]
                                  } Semester`}
                                </td>
                              </tr>
                              {lessonGroups[group].map((lesson) => (
                                <tr
                                  ...
                                  className={`cursor-pointer ${
                                    ...
                                    secColors[index % secColors.length]
                                  }`}
                                >
                  ...
                  <div className="flex flex-row justify-center lg:justify-end lg:mr-4 mb-8">
                    ...
                    <button
                      onClick={() => setShowAdditionalLesson(true)}
                        ...
                        <tbody className="bg-white">
                          {selectedLessons.map((lesson) => (
                            <tr key={lesson.code}>
                              ...
                              <td className="px-4 py-2 border-b text-blue-900 border-gray-500 text-sm leading-5">
                                <button onClick={(e) => selectLessons(lesson)}>
                  ...
                  <div className="py-2 overflow-x-auto sm:px-6 lg:px-8">
                    <div className="align-middle inline-block min-w-full shadow overflow-hidden bg-white shadow-dashboard md:px-8 pt-2 rounded-bl-lg rounded-br-lg">
                      <table className="min-w-full">
                        ...
                        <tbody className="bg-white  ">
                          {searchedLessons.slice(start, end).map((lesson) => (
                            <tr key={lesson.code}>
