...
const Semester = ({ id, name, onDeleteProps }) => {

    const onDeleteUser = async (id, userID, userToken, onDeleteProps, e) => {
        e.preventDefault();
                        ...
                        <div className="flex w-screen" >
                            <div className="mx-auto">
                                <div className="flex m-4">
                                    ...
                                    <button onClick={onDeleteUser.bind(this, id, userID, userToken, onDeleteProps)} className="mx-4" style={{ cursor: "pointer" }}>Delete</button>
