...
const SemesterDetail = ({ history, match }) => {
    ...
    useEffect(() => {
        if (login) {
            ...
            lessonApiInstance.listLessonsOfSemester(
                uid,
                sid,
                (error, data, response) => {
                    if (error) {
    ...
    useEffect(() => {
        ...
        for (let k = 0; k < absences.length; k++) {
            absenceRows.push(
                <tr key={k}>
                    <td className="px-1 sm:px-4 py-2 whitespace-no-wrap border-b text-blue-900 text-left border-gray-500 text-sm leading-5">
                        {absences[k].name}
                    </td>
                    <td className="px-4 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm text-left leading-5">
                        {days[absences[k].day]}
                    </td>
                    <td className="px-0 sm:px-2 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">
                        {absences[k].slot}
                    </td>
                    <td className="px-2 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                        {absences[k].week}
                    </td>
                    <td className="px-2 py-2 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                        {absences[k].date}
    ...
    for (let index = 1; index <= semester.slotCount; index++) {
        scheduleHeads.push(
            <th
                key={index}
                className="px-4 py-2 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider"
            >
                {index}
            </th>
        )
            ...
            <div className="flex flex-col lg:flex-row mt-4 mx-0 xl:mx-32">
                <div className="m-0 md:mx-2 xl:mx-12 overflow-x-auto">
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="bg-white  ">
                            <tr>
                                <td className="px-4 sm:px-8 md:px-16 py-3 border-b text-blue-900 font-bold border-gray-500 text-sm text-left leading-5">
                                    Week Count
                                </td>
                                <td className="px-4 sm:px-8 md:px-20 py-3 border-b text-blue-900 border-gray-500 text-sm text-left leading-5">
                                    {weeksBetween(
                                        semester.startDate,
                                        semester.endDate
                                    )}
                ...
                <div className="px-2 overflow-x-auto">
                    ...
                    <table className="min-w-full">
                        <thead>
                            <tr className="">
                                <th className="px-3 py-2 border-b-2 border-gray-300 text-sm text-left leading-4 text-blue-500 tracking-wider">
                                    #
                                </th>
                                {scheduleHeads}
                            </tr>
                        ...
                        <tbody className="bg-white">
                            <tr>
                                <td className="py-2 border border-gray-500 text-blue-900 font-bold text-sm leading-5">
                                    Mon
                                </td>
                                {scheduleMon}
                            </tr>
            ...
            <div className="flex flex-col lg:flex-row ml-0 xl:ml-32">
                <div className="m-0 md:mx-2 xl:m-10 overflow-x-auto">
                    ...
                    <table className="min-w-full">
                        <thead>
                            <tr className="">
                                <th className="px-1 sm:px-4 py-3 border-b-2 border-gray-300 text-sm text-left leading-4 text-blue-500 tracking-wider">
                                    Lesson Name
                                </th>
                                <th className="px-4 py-3 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider">
                                    Instructor
                                </th>
                                <th className="px-0 sm:px-2 py-3 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider">
                                    Absence
                                </th>
                                <th className="px-2 py-3 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider">
                                    Absence Limit
                                </th>
                        ...
                        <tbody className="bg-white  ">
                            {lessons.map((lesson, index) => {
                                ...
                                let instructor =
                                    resInstructor[resInstructor.length - 1]
                                return (
                                    <tr key={lesson._id}>
                                        <td className="px-1 sm:px-4 py-2 whitespace-no-wrap border-b text-blue-900 font-bold text-left border-gray-500 text-sm leading-5">
                                            <Link
                ...
                <div className="m-0 md:mx-2 xl:my-10 overflow-x-auto">
                    ...
                    <table className="min-w-full">
                        ...
                        <tbody className="bg-white  ">{absences}</tbody>
                    </table>
                </div>
            </div>
        </div>
