...
const AddSemester = ({ history, match }) => {
    ...
    const addSemester = (e) => {
        ...
        if (login) {
            ...
            let apiInstance = new Kucukdevapi.SemestersApi()
            let userSemesterModel = new Kucukdevapi.UserSemesterModel(
                semesterName,
                newStart,
                newEnd,
                hour,
    ...
    const updateSemester = (e) => {
        ...
        if (login) {
            ...
            let apiInstance = new Kucukdevapi.SemestersApi()
            let sid = semesterID
            let updateUserSemesterModel = new Kucukdevapi.UpdateUserSemesterModel(
                semesterName,
                newStart,
                newEnd,
                hour,
                ...
                <div className="flex bg-white shadow-xl rounded flex-col md:w-2/3 sm:w-full mx-auto mt-4">
                    <div className="w-full flex">
                        <div
                            ...
                            style={{
                                backgroundImage: `url("https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=1950&q=80")`,
                            }}
                        ></div>
                        <div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none mx-auto">
                            ...
                            <form
                                onSubmit={
                                    semesterID
                                        ? updateSemester.bind(this)
                                        : addSemester.bind(this)
                                }
