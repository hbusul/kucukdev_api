			...
			<div className="flex bg-white shadow-xl rounded flex-col md:w-2/3 sm:w-full mx-auto xl:mt-12 mt-4">
				<div className="w-full flex">
					<div
						...
						style={{
							backgroundImage: `url("https://images.unsplash.com/photo-1519452635265-7b1fbfd1e4e0?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80")`
						}}
					></div>
					<div className="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none mx-auto">
						...
						<form
							onSubmit={onRegisterUser.bind(this)}
						...
						>
							...
							{validationError && (
								<div
									className="bg-red-100 border-t border-b border-red-500 text-red-700 px-4 py-3 mb-4 flex flex-row"
									role="alert"
								>
							...
							{conflictError && (
								<div
									className="bg-yellow-200 border-t border-b border-yellow-500 text-yellow-700 px-4 py-3 mb-4 flex flex-row"
									role="alert"
								>
									<p className="flex-1 font-bold">
