...
const AddLesson = ({ history, match }) => {
    ...
    useEffect(() => {
        ...
        if (
            !lessonID ||
            slots.length !== 0 ||
            (slots.length === 0 && lessonID)
        ) {
            for (let index = 1; index <= semester.slotCount; index++) {
                scheduleArray.push(
                    <tr key={index}>
                        <td className="px-6 py-1 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                            {hour}
                        </td>
                        <td className="border border-gray-500 text-blue-900 text-sm leading-5">
                            <input
                                onChange={() => selectSlots(`0,${index}`)}
                                checked={slots.includes(`0,${index}`)}
                                type="checkbox"
                            />
                        </td>
                        <td className="border border-gray-500 text-blue-900 text-sm leading-5">
                            <input
                                onChange={() => selectSlots(`1,${index}`)}
                                checked={slots.includes(`1,${index}`)}
                                type="checkbox"
                            />
                        </td>
                        <td className="border text-blue-900 border-gray-500 text-sm leading-5">
                            <input
                                onChange={() => selectSlots(`2,${index}`)}
                                checked={slots.includes(`2,${index}`)}
                                type="checkbox"
                            />
                        </td>
                        <td className="border text-blue-900 border-gray-500 text-sm leading-5">
                            <input
                                onChange={() => selectSlots(`3,${index}`)}
                                checked={slots.includes(`3,${index}`)}
                                type="checkbox"
                            />
                        </td>
                        <td className="border-b border-gray-500 text-blue-900 text-sm leading-5">
                            <input
                                onChange={() => selectSlots(`4,${index}`)}
                                checked={slots.includes(`4,${index}`)}
                                type="checkbox"
                            />
                        </td>
                    </tr>
    ...
    const updateLesson = (e, isDelete) => {
        ...
        let apiInstance = new Kucukdevapi.LessonsApi()
        let updateLessonModel = new Kucukdevapi.UpdateLessonModel(
            lessonName,
            instrutcorName,
            absenceLimit,
            finalSlots
        )
        apiInstance.updateLesson(
            uid,
            sid,
            lid,
            updateLessonModel,
                    ...
                    <div className="w-full flex flex-col md:flex-row">
                        <div className="w-full h-auto lg:block lg:w-7/12 bg-cover rounded-l-lg">
                            ...
                            <table className="min-w-full">
                                <thead>
                                    <tr className="">
                                        <th className="px-6 py-2 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider">
                                            #
                                        </th>
                                        <th className="px-3 py-2 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider">
                                            Mon
                                        </th>
                                        <th className="px-3 py-2 border-b-2 border-gray-300 text-sm leading-4 text-blue-500 tracking-wider">
                                            Tue
                            ...
                            <p className="flex justify-center md:justify-end text-xs italic text-red-500 ml-4 my-2">
                                *You can select slots of the lesson from the
                                slot table.
                            </p>
                        </div>
                                ...
                                <div className="mb-4">
                                    <div className="w-full mb-4 md:mr-2 md:mb-0">
                                        ...
                                        <input
                                            ...
                                            min="0"
                                            onChange={(e) =>
                                                setAbsenceLimit(e.target.value)
                                            }
                                            required
                                        />
                                ...
                                <form className="px-8 pt-6 pb-8 bg-white rounded">
                                    <div className="mb-4">
                                        ...
                                        <p className="flex justify-center text-xs italic text-red-500 my-2">
                                            It is always safer to choose week
                                            number less than what you think, so
                                            you will not have an unpleasent
                                            surprise.
                                        </p>
                                    </div>
                                    <div className="mb-4">
                                        ...
                                        <input
                                            ...
                                            value={lessonPerWeek}
                                            onChange={(e) =>
                                                setLessonPerWeek(e.target.value)
                                            }
                                        />
                                    </div>
                                    <div className="mb-4">
                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="text-left my-4 mx-8">
                                    <p>
                                        After slot changes following absence(s)
                                        do(es) not have any slot to fit:*
                                    </p>
                                        ...
                                        {changedAbsences.map(
                                            (absence, index) => {
                                                ...
                                                return (
                                                    <div
                                                        key={index}
                                                        className="mt-2 bg-gray-300 py-2 px-4 mr-2 rounded-full"
                                                    >{`${resAbs[0]}, ${
                                                        days[resAbs[1]]
                                                    }, ${resAbs[2]}`}</div>
                                                )
                                    ...
                                    <p className="mt-4">
                                        If you click keep, the absence(s) will
                                        be kept and can not be changed from the
                                        absence table. However, if you prefer,
                                        you can delete them inside the lesson
                                        detail page.
                                    </p>
                                    <p className="mt-4">
                                        If you click delete, the absence(s) will
                                        be deleted irreversibly.
                                    </p>
                                </div>
                                <p className="mx-8 text-left text-xs italic text-red-500 my-2">
                                    *The absence format is (Week, Day, Hour).
                                </p>
                    ...
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                        <div className="relative w-auto my-6 mx-auto max-w-3xl">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                ...
                                <div className="text-left my-4 mx-8">
                                    <p>
                                        After you finished selecting slots of
                                        the lesson, you can specify the lab
                                        hours if exists.
                                    </p>
                                    <div className="flex flex-row flex-wrap mx-8">
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <input
                                                        onChange={() =>
                                                            selectLabHours(
                                                                `${resSlot[0]},${resSlot[1]},1`
                                                            )
                                                        }
                                                        checked={isLabSlots.includes(
                                                            `${resSlot[0]},${resSlot[1]},1`
                                                        )}
                                                        className="ml-2"
                                                        type="checkbox"
